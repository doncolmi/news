...
const updatePress = async (items) => {
    const getPress = await axios.get('http://ec2-13-124-136-228.ap-northeast-2.compute.amazonaws.com:18502/press');
    ...
    for(const item of items){
        ...
        if(index === -1) {
            axios.post("http://ec2-13-124-136-228.ap-northeast-2.compute.amazonaws.com:18502/press",
